...
This repository was taken from manjeshpv and will be modified for educational purposes using nodejs, Express and Sails.

The following instructions are described on its website as is shown here:
